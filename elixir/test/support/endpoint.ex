defmodule LiveViewModel.Test.Endpoint do
  @moduledoc false

  use Phoenix.Endpoint, otp_app: :live_view_model

  socket("/socket", LiveViewModel.Test.UserSocket)
  ...
  def config(:otp_app), do: :live_view_model
  def config(:pubsub_server), do: LiveViewModel.Test.PubSub
